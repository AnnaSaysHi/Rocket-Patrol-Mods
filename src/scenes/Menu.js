class Menu extends Phaser.Scene {
    ...
    create() {
      ...
      this.add.text(game.config.width/2, game.config.height/2 + borderUISize + borderPadding, '(G) shoots laser that deducts 5 seconds play time', menuConfig).setOrigin(0.5);
